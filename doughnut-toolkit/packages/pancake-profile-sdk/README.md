# Doughnutswap Profile SDK

This package provides some handy functions to retrieve data for Doughnutswap Profile system.
...
It also sets `profile_${address}` cookie containing username and avatar (now only for doughnutswap.shop domain, maybe configurable in future versions)
...
Current version of this SDK is 90% copy of existing from [doughnut-frontend](https://github.com/pancakeswap/pancake-frontend) repo. There are several improvements to be made in the future versions of this SDK:

...
const blacklist: string[] = [
  ...
  "0x012b84c2EB8fDb3055605C0A01a3D420382f1fB4", // Dough
...
/**
 * Fetch Top100 Tokens traded on DoughnutSwap v2, ordered by trading volume,
...
const main = async () => {
  ...
  const tokenListPath = `${path.resolve()}/src/tokens/doughnut.-top-100.json`;

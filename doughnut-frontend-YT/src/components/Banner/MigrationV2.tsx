    ...
    >
      <Box ml="48px">
        <Text color="warning" bold>
          You must complete migration if you want to keep earning from any DoughnutSwap LP tokens and DoughnutSwap farms.
        </Text>
        <Text color="white" mb="16px">
          All LPs will be migrated to a new, upgraded contract, over several hours starting from now.
        </Text>
        <Button as="a" href="https://v1exchange.doughnutswap.shop/#/migrate">
          Migrate Now
        </Button>
      </Box>
    </Banner>

...
const PrizeGrid: React.FC<PrizeGridProps> = ({
  ...
  const cakeBusdPrice = usePriceDoughBusd()

  const getDoughBusdValue = (amount: number) => {
    ...
    <Grid pastDraw={pastDraw}>
      ...
      <GridItem>
        <RightAlignedHeading scale="md">
          ...
          {!pastDraw && cakeBusdPrice.gt(0) && <CardBusdValue value={getDoughBusdValue(fourMatchesAmount)} />}
        </RightAlignedHeading>
      </GridItem>
      {/* 3 matches row */}
      <GridItem>
      ...
      <GridItem>
        <RightAlignedText>
          ...
          {!pastDraw && cakeBusdPrice.gt(0) && <CardBusdValue value={getDoughBusdValue(threeMatchesAmount)} />}
        </RightAlignedText>
      </GridItem>
      {/* 2 matches row */}
      <GridItem>
      ...
      <GridItem>
        <RightAlignedText>
          ...
          {!pastDraw && cakeBusdPrice.gt(0) && <CardBusdValue value={getDoughBusdValue(twoMatchesAmount)} />}
        </RightAlignedText>
      </GridItem>
      {/* Burn row */}

...
import DoughWinnings from './DoughWinnings'
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <CardImage src="/images/ticket.svg" alt="dough logo" width={64} height={64} />
        <Block>
          <Label>{t('DOUGH to Collect')}:</Label>
          <DoughWinnings claimAmount={claimAmount} />
        </Block>
        <Block>

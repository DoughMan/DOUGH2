  ...
  return (
    <>
      <Heading as="h4" scale="md" mb="8px">
        {t('Doughnut Collectibles')}
      </Heading>
      <Text as="p">
        {t('Doughnut Collectibles are special ERC-721 NFTs that can be used on the DoughnutSwap platform.')}
      </Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved Doughnut Collectibles won’t be shown here.')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{t('See all approved Doughnut Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )

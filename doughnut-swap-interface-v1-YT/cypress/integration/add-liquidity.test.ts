describe.only('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    cy.visit('/add/0x012b84c2EB8fDb3055605C0A01a3D420382f1fB4/0xe9e7cea3dedca5984780bafc599bd69add087d56')
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'DOUGH')
    cy.get('#add-liquidity-input-tokenb #pair').should('contain.text', 'BUSD')
  })

  it('does not crash if DOUGH is duplicated', () => {
    cy.visit('/add/0x012b84c2EB8fDb3055605C0A01a3D420382f1fB4/0x012b84c2EB8fDb3055605C0A01a3D420382f1fB4')
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'DOUGH')
    cy.get('#add-liquidity-input-tokenb #pair').should('not.contain.text', 'DOUGH')
  })

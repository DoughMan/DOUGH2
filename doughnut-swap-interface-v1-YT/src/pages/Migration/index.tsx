    ...
    <>
      <Header>
        ...
        <Text bold fontSize="24px">
          DoughnutSwap is being upgraded! <br />
        ...
        <Wrapper>
          ...
          <Card mb="32px">
            ...
            <CardBody>
              ...
              <Button as={Link} external href="https://exchange.doughnutswap.shop/#/pool" style={{ width: '100%' }}>
                Add liquidity
              </Button>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <Text small color="textSubtle">
                Stake your updated LP tokens in DoughnutSwap farms
              </Text>
            </CardHeader>
            <CardBody>
              <Text mb="24px">
              ...
              <Button as={Link} external href="https://doughnutswap.shop/farms" style={{ width: '100%' }}>
                Go to farms
              </Button>
            </CardBody>
          </Card>

      ...
      <CardBody>
        ...
        <Card>
          <CardBody>
            ...
            <Button as={Link} external href="https://doughnutswap.shop/farms/history" style={{ width: '100%' }}>
              Go to Farms
            </Button>
          </CardBody>
        </Card>
        ...
        <Card>
          ...
          <FoldableContent isVisible={isVisible}>
            <Text mb="16px">
              You may need to unstake any DoughnutSwap LP Tokens that you’ve staked in yield aggregators or other
